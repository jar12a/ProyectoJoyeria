...
<head>
    ...
    <title>Categoría Brazaletes</title>
...
<body>
    ...
    <div class="container mt-5">
        ...
        <div class="row">
            <?php
            // Realizar la consulta a la base de datos para obtener solo los productos de la categoría "Brazaletes"
            ...
            while ($row = $stmt->fetch_assoc()) {
                ...
                echo '                    <button class="btn btn-primary" type="button" id="btn-carrito3-' . $row['ID_Producto'] . '" onclick="agregarAlCarrito(' . $row['ID_Producto'] . ', \'' . $row['Nombre'] . '\', ' . $row['Precio'] . ', \'' . $row['Imagen'] . '\')">';
                ...
                echo '                            <div class="input-group-append">';
                echo '                                <button class="btn btn-primary" type="button" id="btn-modal-carrito3-' . $row['ID_Producto'] . '" onclick="agregarAlCarrito(' . $row['ID_Producto'] . ', \'' . $row['Nombre'] . '\', ' . $row['Precio'] . ', \'' . $row['Imagen'] . '\', true)">';
                echo '                                    <i class="bi bi-cart"></i> Agregar al carrito';
                echo '                                </button>';
                echo '                            </div>';
                echo '                        </div>';
    ...
    <script>
        ...
        function agregarAlCarrito(id, nombre, precio, imagen, isModal = false) {
            ...
            let producto = {
              ...
              let boton = isModal ? document.getElementById(`btn-modal-carrito3-${id}`) : document.getElementById(`btn-carrito3-${id}`);

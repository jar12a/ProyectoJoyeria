...
<body>
    ...
    ?>
        ...
        <div class="col-md-1">
            <button type="button" id="btnAgregar" class="btn btn-primary" onclick="agregarProducto()">Agregar</button>
...
function validarFormulario() {
    ...
    if (!nombre || !tipo || !descripcion || !cantidad || !precio || !material || !imagen) {

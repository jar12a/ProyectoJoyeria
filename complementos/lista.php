    ...
    if (isset($_POST['accion'])) {
        ...
        if ($_POST['accion'] == 'agregar') {
            ...
            if ($stmt->execute([$nombre, $correo, $telefono, $documento, $fecha_nacimiento, $direccion, $estado_civil, $fecha_ingreso, $procedencia, $salario, $nss, $contacto_emergencia, $foto_nombre])) {
                echo "<script>alert('Registro guardado correctamente'); window.location.href='http://localhost:3000/ProyectoJoyeria/complementos/tabla_empleados.php';</script>";
            } else {
        ...
        if ($_POST['accion'] == 'editar') {
            ...
            if ($stmt->execute($params)) {
                echo "<script>alert('Registro actualizado correctamente'); window.location.href='http://localhost:3000/ProyectoJoyeria/complementos/tabla_empleados.php';</script>";
            } else {
                echo "Error: " . $stmt->errorInfo()[2];
            }
        }
